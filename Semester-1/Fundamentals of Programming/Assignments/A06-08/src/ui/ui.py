from src.services.serv_expections import FunctionCallException, UndoException
from src.repository.repo_exceptions import RepositoryException
from src.domain.domain_exceptions import PersonException, ActivityException
