...
from src.a69.services.undo_service import FunctionCall, Operation, CascadedOperation
...
class PersonService:
    ...
    def get_sorted_people(self, compare_function):
        """
        Returns:
             list: A list of sorted activities
        """
        return MyDataStructure.sorted(self.__repository.get_people(), compare_function)
    ...
    def search_people(self, search_word, search_type):
        ...
        result = MyDataStructure.filter(people, validator)
