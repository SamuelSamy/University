...
class Car:
    ...
    def __str__(self):
        return f"License Plate: {self.license_plate} | Make: {self.make} | Model: {self.model} | Color: {self.color}"
...
def generate_cars(n = 50):
    ...
    for i in range(n):
        ...
        car = Car(license_plate, make, model, color)
