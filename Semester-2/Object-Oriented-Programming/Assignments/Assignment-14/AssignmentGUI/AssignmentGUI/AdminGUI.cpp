...
void AdminGUI::initGUI()
{
    ...
    QWidget* undoRedoButtons = new QWidget{};
    QHBoxLayout* hLayoutUR = new QHBoxLayout{ undoRedoButtons };
    ...
    hLayoutUR->addWidget(this->undoButton);
    hLayoutUR->addWidget(this->redoButton);

    vLayout->addWidget(undoRedoButtons);
...
void AdminGUI::connectSignalsAndSlots()
{
    ...
    QObject::connect(this->undoButton, &QPushButton::clicked, this, &AdminGUI::undoHandler);
    QObject::connect(this->redoButton, &QPushButton::clicked, this, &AdminGUI::redoHandler);
    ...
    QObject::connect(this, &AdminGUI::undoSignal, this, &AdminGUI::undo);
    QObject::connect(this, &AdminGUI::redoSignal, this, &AdminGUI::redo);
...
void AdminGUI::undo()
{
    std::string text = "Nothing left to undo";

    bool undid = this->service.undoAction();

    if (undid)
    {
        text = "The last operation was undone!";
        this->populateCoatList();
    }
...
void AdminGUI::redo()
{
    std::string text = "Nothing left to redo";

    bool redid = this->service.redoAction();

    if (redid)
    {
        text = "The last operation was redone!";
        this->populateCoatList();
    }
