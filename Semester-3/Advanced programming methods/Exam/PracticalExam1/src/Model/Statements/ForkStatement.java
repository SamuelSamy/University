...
public class ForkStatement implements StatementInterface {
    ...
    public ProgramState execute(ProgramState state) throws MyException {
        ...
        ProgramState newProgramState = new ProgramState(new MyStack<>(), newSymbolTable, state.getOutput(), state.getFileTable(), state.getHeap(), state.getLatchTable(), this.statement.deepCopy());
