...
public class RunController {
    ...
    public TableView<Map.Entry<Integer, Pair<Integer, List<Integer>>>> semaphoreTable;
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer> semaphoreTableIndex;
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer> semaphoreTableValue;
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> semaphoreTableList;
    ...
    public void initialize() {
        ...
        this.semaphoreTableIndex.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getKey()).asObject());
        this.semaphoreTableValue.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getValue().getKey()).asObject());
        this.semaphoreTableList.setCellValueFactory(param -> new SimpleStringProperty(param.getValue().getValue().getValue().toString()));
    ...
    private void setSemaphoreTable() {
        ...
        this.semaphoreTable.getItems().setAll(FXCollections.observableArrayList(this.controller.getSemaphoreTable().getContent().entrySet()));
    }
