...
public class RunController {
    ...
    public TableView<Map.Entry<String, Pair<List<String>, StatementInterface>>> procTable;
    public TableColumn<Map.Entry<String, Pair<List<String>, StatementInterface>>, String> procTableName;
    public TableColumn<Map.Entry<String, Pair<List<String>, StatementInterface>>, String> procTableParameters;
    public TableColumn<Map.Entry<String, Pair<List<String>, StatementInterface>>, String> procTableBody;
    ...
    public void initialize() {
        ...
        this.procTableName.setCellValueFactory(param -> new SimpleStringProperty(param.getValue().getKey()));
        this.procTableParameters.setCellValueFactory(param -> new SimpleStringProperty(param.getValue().getValue().getKey().toString()));
        this.procTableBody.setCellValueFactory(param -> new SimpleStringProperty(param.getValue().getValue().getValue().toString()));
    }

    private void updateThreadState(ProgramState newState) throws MyException {
        this.setSymbolTable(newState);
        this.setExecutionStack(newState);
    }

    private void setSymbolTable(ProgramState newState) throws MyException {
        if (newState == null) {
            this.symbolTableView.getItems().clear();
            return;
        }
        this.symbolTableView.getItems().setAll(FXCollections.observableArrayList(newState.getCurrentSymbolTable().getContent().entrySet()));
    }
    ...
    private void updateFields() throws MyException {
        this.setNumberOfStates();
        this.setHeapTable();
        this.setOutList();
        this.setFileList();
        this.setProgramStatesList();
        this.setProcedureTable();
    ...
    private void setProcedureTable() {
        ...
        this.procTable.getItems().setAll(FXCollections.observableArrayList(this.controller.getProcedures().getContent().entrySet()));
    }
