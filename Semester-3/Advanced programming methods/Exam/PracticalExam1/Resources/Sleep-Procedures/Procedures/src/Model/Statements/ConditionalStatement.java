...
public class ConditionalStatement implements StatementInterface {
    ...
    public MyDictionaryInterface<String, Type> typeCheck(MyDictionaryInterface<String, Type> table) throws MyException {
        Type typeExp = this.conditionExpression.typeCheck(table);

        if (!typeExp.equals(new BoolType())) {
            throw new MyException("If condition not of type Bool");
        }

        this.thenStatement.typeCheck(table);
        this.elseStatement.typeCheck(table);
        return table;
    }
