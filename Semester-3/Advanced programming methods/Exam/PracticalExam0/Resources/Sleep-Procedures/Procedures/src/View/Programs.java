                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                ...
                                new CompoundStatement(
                                        ...
                                        new PrintStatement(new ArithmeticalExpression('*', new VariableExpression("v"), new ValueExpression(new IntValue(10))))
                                )
                        )
                )
        );
                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                ...
                                new CompoundStatement(
                                        ...
                                        new CompoundStatement(
                                                new CallProcedureStatement("sum", new ArrayList<>(List.of(
                                                        new ArithmeticalExpression('*', new VariableExpression("v"), new ValueExpression(new IntValue(10))),
                                                ...
                                                new CompoundStatement(
                                                        ...
                                                        new ForkStatement(
                                                                new CompoundStatement(
                                                                        new CallProcedureStatement("product", new ArrayList<>(List.of(
                                                                                new VariableExpression("v"),
                                                                                new VariableExpression("w")
                                                                        ))),
                                                                        new ForkStatement(
