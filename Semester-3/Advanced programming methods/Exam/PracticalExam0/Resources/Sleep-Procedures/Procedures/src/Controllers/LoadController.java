...
public class LoadController {
    ...
    public void initialize() throws MyException {
        ...
        // Define procedures
        ProcedureTableInterface procedures = new ProcedureTable();

        StatementInterface sumProcedure = new CompoundStatement(
                new VariableDeclarationStatement("v", new IntType()),
                new CompoundStatement(
                        new AssignmentStatement("v", new ArithmeticalExpression('+', new VariableExpression("a"), new VariableExpression("b"))),
                        new PrintStatement(new VariableExpression("v"))
                )
        );
        List<String> sumParameters = new ArrayList<>();
        sumParameters.add("a"); sumParameters.add("b");
        procedures.put("sum", new Pair<>(sumParameters, sumProcedure));

        StatementInterface prodProcedure = new CompoundStatement(
                new VariableDeclarationStatement("v", new IntType()),
                new CompoundStatement(
                        new AssignmentStatement("v", new ArithmeticalExpression('*', new VariableExpression("a"), new VariableExpression("b"))),
                        new PrintStatement(new VariableExpression("v"))
        ...
        List<String> prodParameters = new ArrayList<>();
        prodParameters.add("a"); prodParameters.add("b");
        procedures.put("product", new Pair<>(prodParameters, prodProcedure));
        ...
        try {
            ...
            repository12.addProgram(programState12);
            ...
            this.programsListView.getItems().add(new RunCommand(programs.get(12).toString(), controller12));
