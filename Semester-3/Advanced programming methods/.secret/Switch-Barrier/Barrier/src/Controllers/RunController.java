...
public class RunController {
    ...
    public TableView<Map.Entry<Integer, Pair<Integer, List<Integer>>>> barrierTable;
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer> barrierTableIndex;
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer> barrierTableValue;
    public TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> barrierTableList;
    ...
    public void initialize() {
        ...
        this.barrierTableIndex.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getKey()).asObject());
        this.barrierTableValue.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getValue().getKey()).asObject());
        this.barrierTableList.setCellValueFactory(param -> new SimpleStringProperty(param.getValue().getValue().getValue().toString()));
    ...
    private void setBarrierTable() {
        ...
        this.barrierTable.getItems().setAll(FXCollections.observableArrayList(this.controller.getBarrierTable().getContent().entrySet()));
    }
