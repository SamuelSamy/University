...
public class ProgramState {
    ...
    private MyStackInterface<MyDictionaryInterface<String, Value>> symbolTable;
    ...
    private ProcedureTableInterface proceduresTable;
    ...
    public ProgramState(
        ...
        this.heap = heap;
        this.proceduresTable = procedures;
    ...
    public MyDictionaryInterface<String, Value> getCurrentSymbolTable() throws MyException {
    ...
    public void setSymbolTable(MyStackInterface<MyDictionaryInterface<String, Value>> symbolTable) {
    ...
    public void setProceduresTable(ProcedureTableInterface table) { this.proceduresTable = table;}
    public ProcedureTableInterface getProceduresTable() {return this.proceduresTable;}
    ...
    public MyStackInterface<MyDictionaryInterface<String, Value>> getFullSymbolTable() {
