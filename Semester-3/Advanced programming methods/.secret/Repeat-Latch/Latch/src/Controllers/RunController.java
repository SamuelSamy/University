...
public class RunController {
    ...
    public TableColumn<Map.Entry<Integer, Integer>, Integer> latchTableLocation;
    public TableColumn<Map.Entry<Integer, Integer>, Integer> latchTableValue;
    ...
    public void initialize() {
        ...
        this.latchTableLocation.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getKey()).asObject());
        this.latchTableValue.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getValue()).asObject());
    ...
    public void setLatchTable() {
        ...
        this.latchTable.getItems().setAll(FXCollections.observableArrayList(this.controller.getLatchTable().getContent().entrySet()));
    }
